        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary">
                    ...
                    <form enctype="multipart/form-data" name="categoryForm" id="categoryForm" method="post" action="<?php echo base_url() . 'admin/category/edit_category/' . $category['categoryID'] ?>">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <?php if ($category['Image'] != "" && file_exists('admin_section/uploads/category/thumbnails/' . $category['Image'])) { ?>
                                    <img src="<?php echo base_url() . 'admin_section/uploads/category/thumbnails/' . $category['Image'] ?>" />
                                <?php } else { ?>
                                    <img src="<?php echo base_url() . 'admin_section/uploads/category/no_image.jpg' ?>" />
                                <?php } ?>
                            </div>
