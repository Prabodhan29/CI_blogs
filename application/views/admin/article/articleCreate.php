        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary">
                    ...
                    <form enctype="multipart/form-data" name="categoryForm" id="categoryForm" method="post" action="<?php echo base_url() . 'admin/article/create_article' ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control <?php echo (form_error('category_id') != "") ? 'is-invalid' : ''; ?>" id="category_id">
                                    ...
                                    ?>
                                    <option <?php echo set_select('category_id', $category['categoryID'], false); ?> value="<?php echo $category['categoryID']; ?>"><?php echo $category['Name']; ?></option>
                                    <?php
                                        }
                                    }
                                    ?>
