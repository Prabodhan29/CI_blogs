    ...
    ?>
            <div class="row mb-5">
                <div class="col-md-4">
                    ...
                    ?>
                        <img class="w-100 rounded" style="width:300px; height:270px;" src="<?php echo base_url('admin_section/uploads/articles/thumbnail_admin/'.$article['Image']) ?>">
                    <?php
                    } else { ?>
                        <img class="w-100 rounded" src="<?php echo base_url('admin_section/uploads/articles/no_image.jpg') ?>">
                    <?php
                    }
                    ?>
